    ...
    partial class Parts {
        WeaponDefinition GFA_Weapon_Ls93LaserCannon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "GFA_SG_TIEFighter_Lasers_IN",
                        MuzzlePartId = "None",
                        AzimuthPartId = "None",
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "_GFA_TIEFighter_LaserCannon_Shot", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "GFA_Particle_TIEFighter_LaserCannon_Muzzle", // SubtypeId of muzzle particle effect.
