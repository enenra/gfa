...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef GFA_Ammo_Ls93LaserCannon => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "L-s9.3 Laser Bolt", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        AlwaysDraw = false,
                        Textures = new[] {
                            "GFA_TIEFighter_LaserCannon_Bullet",
                        },
                    },
                },
            },
