...
namespace Scripts {
    partial class Parts {
        WeaponDefinition GFA_Weapon_H9Turbolaser => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "GFA_LG_Turret_H9",
            ...
            HardPoint = new HardPointDef
            {
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "_GFA_Turret_H9_Shot", // Audio for firing.
            ...
            Animations = GFA_Animation_H9Turbolaser,
        };
    }
}
