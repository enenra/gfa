...
namespace Scripts
{
    partial class Parts
    {
        ...
        {
            AmmoMagazine = "GFA_AmmoMag_Medium_Green", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "H9 Turbolaser Bolt Green", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            TerminalName = "Green Medium Laser Cartridge", // Optional terminal name for this ammo type, used when picking ammo/cycling consumables.  Safe to have duplicates across different ammo defs.
            HybridRound = true, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 300f, // Direct damage; one steel plate is worth 100.
            Mass = 10f, // In kilograms; how much force the impact will apply to the target.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "GFA_Particle_LaserCannon_Muzzle_Green", // SubtypeId of muzzle particle effect.
